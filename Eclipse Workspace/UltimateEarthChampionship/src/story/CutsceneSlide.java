...
/**
 * Cutscene Class
 * Made to be played in a certain order, showing an image and text to the player.
 * This class just contains the information in each 'slide' of the cutscene, which is strung together to
 * form a cohesive cutscene. 
