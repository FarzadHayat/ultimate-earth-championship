...
class ChampionTest {
	...
	void testChangeHealth() {
		...
		testChamp.changeHealth(76);
		
		assertEquals(testChamp.getHealth(), 176);
	}
	...
	void testChangeStamina() {
		...
		testChamp.changeStamina(-8);
		
		assertEquals(testChamp.getStamina(), 22);
		
		testChamp.changeStamina(12);
